...
Color light_cream_background = Color(0xFFFDF8F4);
Color dark_cream_background = Color(0xFFF3E6D6);
Color confirm_order_button = Color(0xFFFF6855);
Color green_color = Color(0xFF78AC95);
List images =[
...
List titles =[
  RichText(
    text: TextSpan(text: 'Star ', style: TextStyle(color: Colors.black,fontSize: 25),children: [
      TextSpan(
          text: 'Fruit',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 25)
      )
    ]),

  ),
  RichText(
    text: TextSpan(text: 'Dragon ', style: TextStyle(color: Colors.black,fontSize: 25),children: [
      TextSpan(
          text: 'Fruit',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 25)
      )
    ]),
  ...
  RichText(
    text: TextSpan(text: 'Papaya ', style: TextStyle(color: Colors.black,fontSize: 25),children: [
      TextSpan(
          text: 'Fruit',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 25)
      )
    ]),
